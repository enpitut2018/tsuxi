...
class CommunitiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create community" do
    assert_difference('Community.count') do
      post communities_url, params: { community: { content: @community.content, name: @community.name } }
    end
  ...
  test "should update community" do
    patch community_url(@community), params: { community: { content: @community.content, name: @community.name } }
